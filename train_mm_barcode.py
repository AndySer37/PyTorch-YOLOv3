...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config_path", type=str, default="config/yolov3_barcode.cfg", help="path to model config")
    parser.add_argument("--data_config_path", type=str, default="config/barcode.data", help="path to data config file")
    parser.add_argument("--checkpoint_model", type=str, help="if specified starts from checkpoint model")
    parser.add_argument("--class_path", type=str, default="data/barcode.names", help="path to class label file")
